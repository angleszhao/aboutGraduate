...
#                index1_1=index1_1+1
         ...
         #   pool1_2_trans=sess.run(tf.transpose(pool1_2, [3, 0, 1, 2]))
          #  print(pool1_2)
           # print(pool1_2_trans)
        #    fig1,ax1 = plt.subplots(nrows=1, ncols=25, figsize = (25,1))
         #   for i in range(25):
          #      print(pool1_2_trans[i][0])
           #     ax1[i].imshow(pool1_2_trans[i][0])
